...
describe('core/fetchFromQuery()', () => {
  ...
  describe('fetch data from async resolvers', () => {
    it('which return object', (done) => {
      ...
      fetchFromQuery({ query, resolvers: asyncResolvers }).then(result => {
        expect(result).toEqual({
          post: {
            _id: 1,
            name: 'Igor',
  ...
  describe('pass arguments to resolver', () => {
    it('pass root', (done) => {
      ...
      fetchFromQuery({ query, resolvers }).then(() => {
        expect(
    ...
    it('pass params', (done) => {
      ...
      fetchFromQuery({ query, resolvers, params }).then(() => {
        expect(
    ...
    it('pass context', (done) => {
      ...
      fetchFromQuery({ query, resolvers, context }).then(() => {
        expect(
